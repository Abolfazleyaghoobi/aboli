    ...
    <>
      <section className=" w-full  flex flex-col  relative ">
        ...
        <div className="mt-3 ">
          <h1
            id="mySkills"
            className="text-center text-[2.5rem] text-gray-500   font-bold test"
          >
            My Skills
          </h1>
        </div>
        ...
        <div className="xxl:w-[62%] xl:w-[70%] lg:w-[87%] mx-auto ">
          ...
          <div className=" w-full  h-90  mx-auto relative  mt-1 ">
            <div className=" bg-[#262b3e] mt-2 rounded-[9px] overflow-hidden px-3 py-4">
